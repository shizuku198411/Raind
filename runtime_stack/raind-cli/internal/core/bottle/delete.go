...
func NewServiceBottleDelete() *ServiceBottleDelete {
	return &ServiceBottleDelete{}
}
...
func (s *ServiceBottleDelete) Delete(param ServiceBottleDeleteModel) error {
	...
	httpClient.NewRequest(
		http.MethodPost,
		fmt.Sprintf("/v1/bottle/%s/actions/delete", param.Target),
		nil,
	)
